...
<head>
    ...
    <script type="text/javascript">
        ...
        load("http://www.xlbweb.cn/sbt/index");
    </script>
</head>
...
<body>
    <div class="container_active">
        ...
        <div class="active_pc">
            <div class="location">
                <i class="icon iconfont icon-llcouponmapmark"></i> 当前位置 > 404
            </div>
            <div class="href">
                <p>404！页面找不到了！将在<span id="time">10</span>秒后自动转入<a href="http://localhost:8080/sbt/index">首页</a>，请稍后...</p>
            </div>
        </div>
        <!-- 页面尾部信息 -->
