...
<body>
    <div class="container_zone">
        ...
        <div class="zone_pc">
            <div class="location">
                <i class="icon iconfont icon-llcouponmapmark"></i> 当前位置 > 个人中心
            </div>
        </div>
        <!-- 页面尾部信息 -->
            ...
            <ul>
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/user/message" style="position: relative;">
                        ...
                        <c:if test="${isRead==1}">
                        	<span style="width='10px';height='10px';border: 1px solid #F90E65;display: block;height: 4px;width: 4px;/* float: right; */position: absolute;top: 14px;right: 46px;border-radius: 2px;background-color: #F90E65;"></span>
                        </c:if>
                    </a>
                </li>
                <li>
